...
Transitions: none internal — the bumper is atomic. Connect to surrounding content externally (`zoom-through-transition` or `image-expand-to-fullscreen` from the host composition).
