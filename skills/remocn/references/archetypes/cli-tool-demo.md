...
- **Background stays static.** `dynamic-grid` at 0.06 opacity or a solid theme fill — never animated under the terminal. The terminal is the focal point; the background must not compete.
