...
<PropsTable
  rows={[
    ...
    },
    {
      ...
      type: "\"light\" | \"dark\"",
      default: "\"light\"",
      description: "Color theme for the card background and text",
    },
    {
      name: "background",
      type: "\"surface\" | \"transparent\"",
      default: "\"surface\"",
      description: "Card background — surface renders white (light) or dark gray (dark); transparent shows no background",
    },
    {
      name: "orientation",
