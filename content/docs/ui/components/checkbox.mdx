...
A complete unchecked → checked → unchecked run using the smooth transition path. Copy the code to drop it into your own composition.

<LiveExample name="checkbox-example" />
