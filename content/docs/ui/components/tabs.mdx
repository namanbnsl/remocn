...
A complete Account → Password → Settings run using the smooth transition path. Copy the code to drop it into your own composition.

<LiveExample name="tabs-example" />
