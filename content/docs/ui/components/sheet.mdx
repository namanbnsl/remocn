...
The live example composes **Button as the trigger**: a primary Button animates through `hover` → `press` states (the "click"), and the sheet slides in right after the press lands, then closes near the end. Copy the code to drop it into your own composition.

<LiveExample name="sheet-example" />
