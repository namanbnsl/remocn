...
A complete closed → opened → closed run using the smooth transition path. Copy the code to drop it into your own composition.

<LiveExample name="accordion-example" />
