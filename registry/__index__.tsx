...
import { iconActivityConfig } from "@/registry/remocn/icon-activity/config";
import { iconAlertTriangleConfig } from "@/registry/remocn/icon-alert-triangle/config";
import { iconArrowDownConfig } from "@/registry/remocn/icon-arrow-down/config";
...
import { iconCalendarConfig } from "@/registry/remocn/icon-calendar/config";
...
import { iconPackageConfig } from "@/registry/remocn/icon-package/config";
...
const registry: Record<string, RegistryEntry> = {
  ...
  "icon-activity": {
    load: () =>
      import("@/registry/remocn/icon-activity").then((m) => ({
  ...
  "icon-arrow-down": {
    load: () =>
      import("@/registry/remocn/icon-arrow-down").then((m) => ({
  ...
  "icon-arrow-right": {
    load: () =>
      import("@/registry/remocn/icon-arrow-right").then((m) => ({
  ...
  "icon-at-sign": {
    load: () =>
      import("@/registry/remocn/icon-at-sign").then((m) => ({
  ...
  "icon-bar-chart-3": {
    load: () =>
      import("@/registry/remocn/icon-bar-chart-3").then((m) => ({
  ...
  "icon-bell": {
    load: () =>
      import("@/registry/remocn/icon-bell").then((m) => ({
        default: m.BellIcon,
      })),
  ...
  "icon-bookmark": {
    load: () =>
      import("@/registry/remocn/icon-bookmark").then((m) => ({
  ...
  "icon-calendar": {
    load: () =>
      import("@/registry/remocn/icon-calendar").then((m) => ({
  ...
  "icon-check": {
    load: () =>
      import("@/registry/remocn/icon-check").then((m) => ({
        default: m.CheckIcon,
      })),
  ...
  "icon-chevron-left": {
    load: () =>
      import("@/registry/remocn/icon-chevron-left").then((m) => ({
  ...
  "icon-chevron-up": {
    load: () =>
      import("@/registry/remocn/icon-chevron-up").then((m) => ({
  ...
  "icon-clock": {
    load: () =>
      import("@/registry/remocn/icon-clock").then((m) => ({
        default: m.ClockIcon,
      })),
  ...
  "icon-code": {
    load: () =>
      import("@/registry/remocn/icon-code").then((m) => ({
        default: m.CodeIcon,
      })),
  ...
  "icon-database": {
    load: () =>
      import("@/registry/remocn/icon-database").then((m) => ({
  ...
  "icon-dollar-sign": {
    load: () =>
      import("@/registry/remocn/icon-dollar-sign").then((m) => ({
  ...
  "icon-download": {
    load: () =>
      import("@/registry/remocn/icon-download").then((m) => ({
  ...
  "icon-eye-off": {
    load: () =>
      import("@/registry/remocn/icon-eye-off").then((m) => ({
  ...
  "icon-eye": {
    load: () =>
      import("@/registry/remocn/icon-eye").then((m) => ({
        default: m.EyeIcon,
      })),
  ...
  "icon-flame": {
    load: () =>
      import("@/registry/remocn/icon-flame").then((m) => ({
        default: m.FlameIcon,
      })),
  ...
  "icon-folder": {
    load: () =>
      import("@/registry/remocn/icon-folder").then((m) => ({
  ...
  "icon-gift": {
    load: () =>
      import("@/registry/remocn/icon-gift").then((m) => ({
        default: m.GiftIcon,
      })),
  ...
  "icon-globe": {
    load: () =>
      import("@/registry/remocn/icon-globe").then((m) => ({
        default: m.GlobeIcon,
      })),
  ...
  "icon-heart": {
    load: () =>
      import("@/registry/remocn/icon-heart").then((m) => ({
        default: m.HeartIcon,
      })),
  ...
  "icon-help-circle": {
    load: () =>
      import("@/registry/remocn/icon-help-circle").then((m) => ({
  ...
  "icon-image": {
    load: () =>
      import("@/registry/remocn/icon-image").then((m) => ({
        default: m.ImageIcon,
      })),
  ...
  "icon-key": {
    load: () =>
      import("@/registry/remocn/icon-key").then((m) => ({
        default: m.KeyIcon,
      })),
  ...
  "icon-link": {
    load: () =>
      import("@/registry/remocn/icon-link").then((m) => ({
        default: m.LinkIcon,
      })),
  ...
  "icon-menu": {
    load: () =>
      import("@/registry/remocn/icon-menu").then((m) => ({
        default: m.MenuIcon,
      })),
  ...
  "icon-message-circle": {
    load: () =>
      import("@/registry/remocn/icon-message-circle").then((m) => ({
  ...
  "icon-monitor": {
    load: () =>
      import("@/registry/remocn/icon-monitor").then((m) => ({
  ...
  "icon-package": {
    load: () =>
      import("@/registry/remocn/icon-package").then((m) => ({
  ...
  "icon-pencil": {
    load: () =>
      import("@/registry/remocn/icon-pencil").then((m) => ({
  ...
  "icon-play": {
    load: () =>
      import("@/registry/remocn/icon-play").then((m) => ({
        default: m.PlayIcon,
      })),
  ...
  "icon-save": {
    load: () =>
      import("@/registry/remocn/icon-save").then((m) => ({
        default: m.SaveIcon,
      })),
  ...
  "icon-settings": {
    load: () =>
      import("@/registry/remocn/icon-settings").then((m) => ({
  ...
  "icon-skip-forward": {
    load: () =>
      import("@/registry/remocn/icon-skip-forward").then((m) => ({
  ...
  "icon-sparkles": {
    load: () =>
      import("@/registry/remocn/icon-sparkles").then((m) => ({
  ...
  "icon-terminal": {
    load: () =>
      import("@/registry/remocn/icon-terminal").then((m) => ({
  ...
  "icon-trending-down": {
    load: () =>
      import("@/registry/remocn/icon-trending-down").then((m) => ({
  ...
  "icon-upload": {
    load: () =>
      import("@/registry/remocn/icon-upload").then((m) => ({
  ...
  "icon-user-plus": {
    load: () =>
      import("@/registry/remocn/icon-user-plus").then((m) => ({
  ...
  "icon-user": {
    load: () =>
      import("@/registry/remocn/icon-user").then((m) => ({
        default: m.UserIcon,
      })),
  ...
  "icon-video": {
    load: () =>
      import("@/registry/remocn/icon-video").then((m) => ({
        default: m.VideoIcon,
      })),
  ...
  "icon-volume-2": {
    load: () =>
      import("@/registry/remocn/icon-volume-2").then((m) => ({
  ...
  "icon-check-circle": {
    load: () =>
      import("@/registry/remocn/icon-check-circle").then((m) => ({
