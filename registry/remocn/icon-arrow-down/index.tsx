...
const SHAFT_PATH = "M12 5v14";
const HEAD_PATH = "m19 12-7 7-7-7";
...
export function ArrowDownIcon({
  ...
  const nudgeY = 6 * (actionProgress < 0.5 ? outward : settle);
  ...
  return (
    ...
    >
      <g transform={`translate(0 ${nudgeY})`}>
        <path
          d={SHAFT_PATH}
...
export function ArrowDownIconStatic({
  size = 48,
  color = "currentColor",
  strokeWidth = 2,
  className,
